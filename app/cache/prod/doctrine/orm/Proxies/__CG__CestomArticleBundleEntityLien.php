 ...
 */
class Lien extends \Cestom\ArticleBundle\Entity\Lien implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Lien' . "\0" . 'id', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Lien' . "\0" . 'lien', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Lien' . "\0" . 'titre', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Lien' . "\0" . 'article');
        }
