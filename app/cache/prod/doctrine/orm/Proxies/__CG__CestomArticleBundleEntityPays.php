 ...
 */
class Pays extends \Cestom\ArticleBundle\Entity\Pays implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Pays' . "\0" . 'id', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Pays' . "\0" . 'pays', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Pays' . "\0" . 'articles');
        }
