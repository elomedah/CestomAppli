 ...
 */
class Telephone extends \Cestom\StoreBundle\Entity\Telephone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cestom\\StoreBundle\\Entity\\Telephone' . "\0" . 'numeroTel', '' . "\0" . 'Cestom\\StoreBundle\\Entity\\Telephone' . "\0" . 'idmembre');
        }
