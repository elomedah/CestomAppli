...
/* login.html.twig */
class __TwigTemplate_c6a3d5c67973c0d8a33e2307031e90e1e630d667e8814be0e672b30cce7bf2d3 extends Twig_Template
{
...
\t\t\t\t";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "e7a029c_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_e7a029c_0") : $this->env->getExtension('assets')->getAssetUrl("images/e7a029c_icone-site-cestom_1.png");
            // line 34
            echo "\t\t\t\t\t<img src=\"";
...
\t\t\t\t";
            ...
            // asset "e7a029c"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_e7a029c") : $this->env->getExtension('assets')->getAssetUrl("images/e7a029c.png");
            echo "\t\t\t\t\t<img src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\" class=\"etoile-cestom\" alt=\"etoile-cestom\"/>
\t\t\t\t";
