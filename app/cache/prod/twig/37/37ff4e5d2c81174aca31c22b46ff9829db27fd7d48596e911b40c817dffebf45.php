...
class __TwigTemplate_fff94b03f5933b157505854d0f15aaaf23e9f13c617e8c00f587aa679bd91617 extends Twig_Template
{
...
\t\t\t\t\t\tonclick=\"javascript:getPage('";
        // line 60
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("cestomarticlebundle_article_showPublic", array("id" => $this->getAttribute($this->getAttribute((isset($context["block2"]) ? $context["block2"] : null), "topArticle", array()), "id", array()))), "html", null, true);
        echo "','main-block');\">
\t\t\t\t\t\t";
        // line 61
