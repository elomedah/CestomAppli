...
class __TwigTemplate_b76682256c0d8c55502a70fd9471e706efa2bcd730d98e20de86cb488f338e3e extends Twig_Template
{
        ...
        echo "
                 \t\t\t<fieldset>
                    <div class=\"col-sm-10 widget-main\">
                        ...
                        ";
        // line 5
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "typeDoc", array()), 'label', array("label_attr" => array("class" => "col-sm-3 control-label "), "label" => "Type de document "));
        echo "

                        ";
        // line 7
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "typeDoc", array()), 'widget', array("attr" => array("class" => "col-xs-10 col-sm-5")));
        echo "
