 ...
 */
class Categorie extends \Cestom\ArticleBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Categorie' . "\0" . 'categorie', '' . "\0" . 'Cestom\\ArticleBundle\\Entity\\Categorie' . "\0" . 'articles');
        }
