...
class __TwigTemplate_3f34f45d5b0c0ad9be7866142386e44c3c5d5ef0c1106246985692f2ee5850c8 extends Twig_Template
{
...
\t\t\t\t\t\t<a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute((isset($context["mesRoutes"]) ? $context["mesRoutes"] : $this->getContext($context, "mesRoutes")), "show", array()), array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">[";
...
\t\t\t\t\t\t\t<a href=\"";
            // line 31
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute((isset($context["mesRoutes"]) ? $context["mesRoutes"] : $this->getContext($context, "mesRoutes")), "edit", array()), array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
...
\t\t\t<div class=\"row panel-body gray-black border-radius\">
\t\t
\t\t\t<div>
\t\t\t\t<a href=\"";
        // line 45
