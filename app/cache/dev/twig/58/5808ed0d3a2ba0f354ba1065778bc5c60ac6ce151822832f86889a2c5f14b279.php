...
class __TwigTemplate_0089523b7c7a3df07c52334ea5aa245421fd7c72a2217cdeb9fd587e71f2c232 extends Twig_Template
{
...
\t\t\t\t\t<!--<td>";
        // line 25
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "introImg", array()), "html", null, true);
        echo "</td>-->
\t\t\t\t\t<td>
\t\t\t\t\t\t<a  href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('vich_uploader')->asset((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "introImgFile"), "html", null, true);
        echo "\" title=\"Cliquez pour agrandir\" class=\"zoom\">
\t\t\t\t\t\t\t<img src=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('vich_uploader')->asset((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "introImgFile"), "html", null, true);
        echo "\" alt=\"image article\" class=\"img-responsive img-thumbnail image-articles \"/>
\t\t\t\t\t\t</a>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t\t<tr>
...
\t\t\t\t\t<td>";
        // line 34
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "introduction", array()), "html", null, true);
        echo "</td>
\t\t\t\t</tr>
\t\t\t\t<tr>
\t\t\t\t\t<th>Contenu</th>
...
\t\t\t\t\t<td>";
        // line 46
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "creation", array()), "Y-m-d H:i:s"), "html", null, true);
        echo "</td>
\t\t\t\t</tr>
\t\t\t\t<tr>
...
\t\t\t\t\t<td>";
        // line 50
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "debutDePublication", array()), "Y-m-d H:i:s"), "html", null, true);
        echo "</td>
\t\t\t\t</tr>
\t\t\t\t<tr>
...
\t\t\t\t\t<td>";
        // line 54
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "finDePublication", array()), "Y-m-d H:i:s"), "html", null, true);
        echo "</td>
\t\t\t\t</tr>
\t\t\t</tbody>
\t\t</table>
...
\t\t\t\t\t<a href=\"";
        // line 71
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute((isset($context["mesRoutes"]) ? $context["mesRoutes"] : $this->getContext($context, "mesRoutes")), "edit", array()), array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\" class=\"btn btn-default \">
\t\t\t\t\t\tEditer
\t\t\t\t\t</a>
\t\t\t\t</span>
...
/* 							<img src="{{ vich_uploader_asset(entity, 'introImgFile') }}" alt="image article" class="img-responsive img-thumbnail image-articles "/>*/
/* 						</a>*/
/* 					</td>*/
/* 				</tr>*/
/* 				<tr>*/
