...
class __TwigTemplate_1ca97862c99d17e3c969782cf353eb04a99a3bb7159af08472bdd7a15529014d extends Twig_Template
{
  ...
  <div class=\"col-sm-10 widget-main\">
        ...
        echo "
                    ...
                    <div class=\"col-sm-10 widget-main\">
                        ...
                        ";
        // line 105
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "fichierPhotoMimMembre", array()), 'label', array("label_attr" => array("class" => "col-sm-3 control-label "), "label" => "Photo du membre "));
        echo "
...
/*                     <div class="col-sm-10 widget-main">*/
/* */
/*                         {{ form_label(form.fichierPhotoMimMembre, "Photo du membre ", {'label_attr': {'class': 'col-sm-3 control-label '}}) }}*/
/* */
