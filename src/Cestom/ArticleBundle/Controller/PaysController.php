...
use Cestom\ArticleBundle\Entity\Pays;
use Cestom\ArticleBundle\Form\PaysType;
...
class PaysController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CestomArticleBundle:Pays')->findAll();

        return $this->render('CestomArticleBundle:Pays:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CestomArticleBundle:Pays:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CestomArticleBundle:Pays')->find($id);
        ...
        return $this->render('CestomArticleBundle:Pays:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CestomArticleBundle:Pays:edit.html.twig', array(
            'entity'      => $entity,
