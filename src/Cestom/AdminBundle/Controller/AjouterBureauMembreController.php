...
class AjouterBureauMembreController extends Controller
{
  public function ajouterBureauMembreAction(Request $request)
  {
...
$request->getSession()->getFlashBag()->add('messageerror', 'Echec d\'ajout du membre dans le bureau : Le membre occupe déjà cette fonction' . $e);
    return $this->render('CestomAdminBundle:GestionMembre:ajouterBureau.html.twig', array(
      'form' => $form->createView(), 'bureaux'=>$bureaux
    ));
}
  }else {
$request->getSession()->getFlashBag()->add('messageerror', 'Echec d\'ajout du membre dans le bureau ');
    return $this->render('CestomAdminBundle:GestionMembre:ajouterBureau.html.twig', array(
      'form' => $form->createView(), 'bureaux'=>$bureaux
    ));
}
